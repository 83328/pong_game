...
## Contributors:
[![GitHub](https://img.shields.io/badge/GitHub-henniphilo-red?style=plastic&logo=github)](https://github.com/henniphilo)
[![GitHub](https://img.shields.io/badge/GitHub-panndabea-yellow?style=plastic&logo=github)](https://github.com/panndabea)
[![GitHub](https://img.shields.io/badge/GitHub-83328-blue?style=plastic&logo=github)](https://github.com/83328)
[![GitHub](https://img.shields.io/badge/GitHub-42OK42-green?style=plastic&logo=github)](https://github.com/42OK42)
...
| **Server-Side Pong** | Replacing Basic Pong with Server-Side Pong and Implementing an [API](docs/how_to_gamestats.md) | Major | 10 | ✅ |
| Server-Side Pong | Enabling Pong Gameplay via CLI against Web Users with API Integration | Major | 10 | [ ] |
| Testing | Implementing a [CI/CD](docs/testing.md) testing protocol | Extra | x | ✅ |
...
Read more about ELK in the docs/elastic_search.md.  
And about Grafana in the docs/grafana.md.
